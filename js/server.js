...
app.use(express.static(path.join(__dirname, '..'))); //permite al navegador cargar HTML directamente
...
app.listen(PORT, () => {
    ...
    console.log(`Accede a la página principal en http://localhost:${PORT}/MisPlantas.html`);
});